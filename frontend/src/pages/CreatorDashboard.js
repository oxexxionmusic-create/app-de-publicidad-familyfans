...
<Input type="number" step="0.01" min="10" value={wdForm.amount} onChange={e => setWdForm({...wdForm, amount: e.target.value})} required />
</div>
<div>
<Label>Metodo</Label>
...
<Input value={wdForm.wallet_address} onChange={e => setWdForm({...wdForm, wallet_address: e.target.value})} placeholder="0x..." />
</div>
)}
{wdForm.method === 'bank' && (
<div>
<Label>Datos Bancarios</Label>
<Textarea value={wdForm.bank_details} onChange={e => setWdForm({...wdForm, bank_details: e.target.value})} placeholder="Banco, titular, cuenta..." />
</div>
)}
...
<Input type="number" step="0.01" min="0.50" value={premiumPrice} onChange={e => setPremiumPrice(e.target.value)} required />
</div>
<div>
<Label>Descripcion</Label>
<Textarea value={premiumDesc} onChange={e => setPremiumDesc(e.target.value)} placeholder="Que incluye tu suscripcion..." />
</div>
...
<Input type="number" step="0.01" value={finForm.amount_requested} onChange={e => setFinForm({...finForm, amount_requested: e.target.value})} />
</div>
<div>
...
<Textarea value={finForm.streaming_stats} onChange={e => setFinForm({...finForm, streaming_stats: e.target.value})} placeholder="Oyentes mensuales, seguidores..." />
</div>
<div>
...
<Input value={playlistForm.playlist_url} onChange={e => setPlaylistForm({...playlistForm, playlist_url: e.target.value})} placeholder="https://open.spotify.com/playlist/..." required />
</div>
<div>
...
<Input type="number" min="5" max="25" value={playlistForm.song_count} onChange={e => setPlaylistForm({...playlistForm, song_count: parseInt(e.target.value)||5})} />
</div>
<div>
<Label>Seguidores/Me gusta (min 10)</Label>
<Input type="number" min="10" value={playlistForm.followers} onChange={e => setPlaylistForm({...playlistForm, followers: parseInt(e.target.value)||0})} />
</div>
</div>
...
<Input type="number" min="100" value={curatorPayForm.listens_count} onChange={e => setCuratorPayForm({...curatorPayForm, listens_count: parseInt(e.target.value)||0})} />
</div>
<div>
<Label>Descripcion de Evidencia</Label>
<Textarea value={curatorPayForm.evidence_description} onChange={e => setCuratorPayForm({...curatorPayForm, evidence_description: e.target.value})} placeholder="Describe las pruebas de escucha..." />
</div>
<div>
...
<Textarea value={levelReqForm.justification} onChange={e => setLevelReqForm({...levelReqForm, justification: e.target.value})} placeholder="Explica por que mereces subir de nivel..." />
</div>
<div>
<Label>Enlaces de Portafolio</Label>
<Textarea value={levelReqForm.portfolio_links} onChange={e => setLevelReqForm({...levelReqForm, portfolio_links: e.target.value})} placeholder="Enlace 1, Enlace 2..." />
</div>
<Button type="submit" className="w-full">Enviar Solicitud</Button>
</form>
</DialogContent>
